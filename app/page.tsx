...
export default function Home() {
	...
	return (
		<div className="h-dvh w-full flex flex-col items-center">
			<div className='text-2xl font-semibold text-center py-6 flex space-x-4'>
				...
				<a href='https://dok-photos.fdma.dev/'target='_blank' className='self-center'><SiImmich className='w-6 h-6'/></a>
			</div>
